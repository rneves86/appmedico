...
<html lang="pt-br">
  <head>
    ...
    <title>Medical Production</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            <li><a href="#"><i class="fa fa-user"></i> Empresa</a></li>
                            <li><a href="#"><i class="fa fa-heart"></i> Prestador</a></li>
                            <li><a href="#"><i class="fa fa-shopping-cart"></i> Convênio</a></li>
                            <li><a href="#"><i class="fa fa-lock"></i> Usuario</a></li>
                            <li><a href="#"><i class="fa fa-lock"></i> Sair</a></li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="header-right">
                        <ul class="list-unstyled list-inline">
                            <li class="dropdown dropdown-small">
                                <a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" href="#"><span class="key">Prestador :</span><span class="value">BRL </span><b class="caret"></b></a>
                                <ul class="dropdown-menu">
                                    <li><a href="#">Cadastro</a></li>
                                    <li><a href="#">Atividade Medica</a></li>
                                    <li><a href="#">Empresa x Prestador</a></li>
                                </ul>
                            </li>
